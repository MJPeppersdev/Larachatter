...
use Launcher\Larachatter\Events\UserGoesActive;
use Launcher\Larachatter\Events\UserGoesInactive;
use Launcher\Larachatter\Events\UserStatusChanged;
...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            $slug = config('larachatter.fields.slug');
